...
class VideoDataset():
    ...
    def random_select_frames(self, video, image_frame_idx):
        ...
        selected_frames = ms.ops.cat(selected_frames_list, axis=0)  # 540*t,C,H,W; t=num_selected_frames
    ...
    def load_goat_data(self, data: dict, key: tuple):
        if self.args.use_goat:
            if self.args.use_formation:
                ...
                data['formation_features'] = convert_tensor(self.formation_features_dict[key])  # 540,1024 [Middle]
                ...
                data['bp_features'] = ms.ops.cat(bp_features_list, axis=0).to(ms.float32)  # 540,768
    ...
    def __getitem__(self, ix):
        ...
        data['feature'] = convert_tensor(self.feature_dict[key])  # 540,1024
        data['key'] = key
